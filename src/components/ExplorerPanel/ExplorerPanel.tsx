      ...
      <div className="explorer-panel-option-bar">
        <div className="option-bar-bt">
          ...
          <div id="add-panel-alert" className="option-bar-bt">
            ...
            <div className="option-inner-btadd"><div className="option-inner-btadd-tittle">Add new</div>
            <div className="option-inner-btadd-addBtArea">
              <div className="option-inner-btadd-addBtAreaBt"><div className="add-new-bloc-bt"></div></div>
              <div className="option-inner-btadd-addBtAreaBt"><div className="add-new-bloc-bt"></div></div>
              <div className="option-inner-btadd-addBtAreaBt"><div className="add-new-bloc-bt"></div></div><div className="option-inner-btadd-addBtAreaBt">
                <div className="add-new-bloc-bt"></div></div></div></div>
            </div></div>
